...
- Open item: exact model availability/naming and pricing on Sumopod for Claude Sonnet 4.6 (or nearest equivalent) needs confirming during Story 1.2 implementation — not yet verified.
